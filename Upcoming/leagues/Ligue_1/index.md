...
The predicted results of the following Ligue_1 matches in comparison with the bookmaker's odds can be seen in the following figure (**Unfortunately not working on mobile devices**):
...
<iframe src="PredictionTable.html" width="3000" height="800" frameborder="0" allowfullscreen="true" scrolling="no"></iframe> 
*A table of the model's predictions of the upcoming Ligue_1 games. The most popular bets are shown such as (GG, NG) which refers to GoalGoal and NoGoal, (Over,Under) and HomeWin, Draw and AwayWin.*
